...
async def no_cache_app_pages(request, call_next):
    ...
    if path in ('/', '/cobrador', '/cobrador/', '/cadastro', '/cadastro/') or path.startswith('/static/chat-') or path == '/static/chat.css' or path == '/static/v17-payment-actions.js' or path.startswith('/static/public-register.') or path == '/static/v12-core.js':
